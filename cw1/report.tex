...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{A/initial_fit_plot}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{B/model_evidence_contour.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{C/periodic_covariance_plot}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{E/raw_data}
